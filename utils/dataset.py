...
from . import general #to avoid this: from acme_diags.driver import utils
from . import climo
...
class Dataset():
    def __init__(self, parameters, ref=False, test=False, derived_vars={}, climo_fcn=None):
        ...
        if not self.derived_vars:
            ...
            #Not using this: acme_diags.derivations.acme.derived_variables
            self.derived_vars = {
                'PRECT': collections.OrderedDict([
    ...
    def get_timeseries_variable(self, var, extra_vars=[], *args, **kwargs):
        ...
        for variable in variables:
            variable = general.adjust_time_from_time_bounds(variable)
